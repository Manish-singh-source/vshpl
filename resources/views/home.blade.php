...
<body>
    ...
    <div class="container ">
        <div class="column" style="background-image: url('https://www.shutterstock.com/image-photo/generate-image-background-inspired-by-600nw-2600403503.jpg');">
            <h1>Register as a Cricket Player</h1>
            <p>Register now to join our cricket community and showcase your skills. Be part of exciting matches, tournaments, and a growing network of cricket enthusiasts.</p>
            <button><a href="https://veenasmarthomes.com/vshpl" target="_blank">Register Now</a> </button>
        </div>
        <div class="column" style="background-image: url('https://www.shutterstock.com/image-photo/neon-3d-image-cricket-stadium-600nw-2588682129.jpg');">
